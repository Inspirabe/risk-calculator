...
export class TabsPage implements OnInit {
    ...
    async ngOnInit(): Promise<void> {
        ...
        // let params: HttpParams = new HttpParams().set('test', 123);
        let url:string = 'https://werkplek.inspira.be/api/v1/platform/';
        // let url:string = 'https://inspiratest.werkplek.biz/api/v1/platform/';
